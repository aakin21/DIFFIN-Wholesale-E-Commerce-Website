  ...
  hu: {
    translation: {
      ...
      "productDetail": {
        ...
        "perPiece": "/ db",
        "seriesPrice": "Sorozat ára:",
        "seriesDescription": "1 sorozat = S, M (×2), L, XL — összesen 5 db",
        "wholesaleNote": "Termékeinket kizárólag nagykereskedelemre kínáljuk, minden ár darabár. Minőségi anyagokkal, precíz varrással és színtartósság garanciával. Raktáron, gyors szállítással.",
  ...
  tr: {
    translation: {
      ...
      "productDetail": {
        ...
        "inStock": "STOKTA VAR",
        "perPiece": "/ adet",
        "seriesPrice": "Seri fiyatı:",
        "seriesDescription": "1 seri = S, M (×2), L, XL — toplam 5 adet",
        "wholesaleNote": "Ürünlerimiz toptan satışa özeldir ve her ürün fiyatı adet fiyatıdır. Yüksek adet üretim, kaliteli kumaş ve özeni dikim garantisiyle sunulmaktadır. Stoklu ve hızlı teslimat mevcuttur.",
  ...
  en: {
    translation: {
      ...
      "productDetail": {
        ...
        "wholesaleNote": "Our products are exclusively for wholesale. Each listed price is per piece. Available in high quantities with quality fabric, careful stitching and color fastness guarantee. In stock with fast delivery.",
